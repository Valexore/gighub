...
export default function Bosses() {
  ...
  const boxes = [
    {
      id: 1,
      title: "Cut 10 meter tree, add a website while fixing the faucet.",
      button: "Add Details",
      details: "Details",
    },
    {
    ...
    },
    {
      ...
      title: "Fix roof leak",
      button: "Add Details",
      details: "Add your gig details to continue",
    },
    {
      id: 6,
      title: "Home Service LCD Repair",
      button: "View",
      details: "Details",
    },
  ...
  const gigDaddy = [
    {
      ...
      description:
        "This is a description of my profile, i do varous task with complete and trustable information using verified account information.",
    },
    {
      id: 2,
      name: "Jay Untalan",
    ...
    },
    {
      ...
      jobs: "23",
      hourly: "₱40/hr",
      title: "Baking | Knitting | Dishwasher",
      description:
        "This is a description of my profile, i do varous task with complete and trustable information using verified account information.",
    },
    {
      id: 6,
      name: "Aquino Dela pena",
      location: "Manila",
      jobSuccess: "50%",
      jobs: "56",
      hourly: "₱73/hr",
  ...
  return (
    <main className="pb-16 md:pb-0">
      ...
      <div className="mt-3">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between px-4 md:px-25 md:mt-[100px] mt-[80px]">
          <header className="text-[1.5rem] font-[500]">
            Welcome, Ivanotch
          </header>
          <div className="flex flex-col md:flex-row items-center gap-3 mt-3">
            <Button
              onClick={() => router.push("/gigbosses/postgig")}
              className="bg-primary-600 text-white w-full md:w-[150px] h-[40px] text-[1.1rem] gap-2"
              variant="outline"
            >
              <BadgePlus />
              Post a gig
            ...
            <Button
              ...
              className="bg-primary-600 text-white w-full md:w-[160px] h-[40px] text-[1.1rem] gap-2"
              variant="outline"
            >
              <UserRoundSearch />
              Find gigdaddy
      ...
      <div className="px-4 md:px-25">
        <header className="text-[1.95rem] font-[400] my-[1rem]">
          Finish setting up to hire a GigDaddy
        </header>
        <div className="flex flex-col md:flex-row gap-4">
          <div
            onClick={() => setOpen(true)}
            className="flex border-1 rounded-md p-5"
          >
            <div className="flex flex-col ">
              <p className="text-slate-600 text-[0.9rem] font-[400]">
                Required to publish a gig
              </p>
          ...
          <div className="flex border-1 rounded-md p-5">
            <div className="flex flex-col ">
              ...
              <p className="text-[1rem]">
                This can increase your hiring speed by up to 3x. There's no cost
                untile you hire.
              </p>
            </div>
      ...
      <div className="px-4 md:px-25 mt-[3rem] mb-[3rem]">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center">
          ...
          {/* Tabs */}
          <div className="flex rounded-full border border-gray-300 overflow-hidden self-start md:self-auto">
            {/* GRID TAB */}
            <button
        ...
        {active === "grid" ? (
          <div className="relative">
            ...
            <div
              ref={containerRef}
              className={`flex gap-4 overflow-x-auto md:overflow-hidden scroll-smooth pb-3`}
            >
              {boxes.map((box) => (
                <div
                  key={box.id}
                  className="w-[90vw] md:w-[410px] h-[280px] flex-shrink-0 border border-slate-400 rounded-sm p-5 flex flex-col"
                >
                  {/* Header */}
                  ...
                  <div className="flex flex-col gap-3 h-full">
                    ...
                    <Button className="mt-auto border border-1 rounded-sm bg-white border-blue-700 text-primary-700 hover:bg-blue-700 hover:text-white">
                      {box.button}
                    </Button>
                  </div>
                </div>
            ...
            {boxes.length > 3 && (
              <button
                onClick={scrollRight}
                className="hidden md:flex absolute right-[-1.5rem] top-1/2 -translate-y-1/2 
               bg-white border border-gray-300 rounded-full p-2 shadow z-10"
              >
      ...
      <div className="px-4 md:px-25 mt-[3rem] mb-[3rem]">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center">
          <header className="text-[1.95rem] font-[400] my-[1rem]">
            Book With Expert GigDaddy
          </header>
          <div className="flex gap-3 self-start md:self-auto">
            <p>Browse GigDaddy</p> <ArrowRight />
          </div>
        </div>
          ...
          <div className="relative">
            ...
            >
              {gigDaddy.map((box) => (
                <div
                  key={box.id}
                  className="w-[90vw] md:w-[304px] h-[380px] flex-shrink-0 border border-slate-400 rounded-sm p-5 flex flex-col"
                >
                  {/* Header */}
                  ...
                  <div className="flex justify-around my-[0.5rem]">
                    <div className="flex items-center flex-col">
                      ...
                      <p className="font-[500] text-[0.8rem] text-slate-700">
                        Job Success
                      </p>
                    </div>
                    <div className="flex items-center flex-col">
            ...
            <div className="fixed bottom-0 fixed left-0 right-0 bg-white shadow-lg border-t z-50 md:hidden">
              <div className="flex justify-around py-3">
                ...
                >
                  <NotepadText size={22} />
                  <span className="text-[0.7rem]">Manage Gig</span>
                </button>
                ...
                >
                  ...
                  <span className="text-[0.7rem]">Message</span>
                </button>
              </div>
            </div>
      ...
      {open && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white flex flex-col items-center p-6 w-[90%] max-w-[40rem] h-[25rem] rounded-lg shadow-xl">
            ...
            <h2 className="text-xl text-center mb-[1.5rem] font-semibold mb-3">
              Please Verify your phone number
            </h2>
            <p className="mb-[2rem] text-center mt-[1rem]">
      ...
      {openEmail && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white flex flex-col items-center p-6 w-[90%] max-w-[40rem] h-[23rem] rounded-lg shadow-xl">
            <div className="flex w-full justify-end items-center">
              <div className="" onClick={() => setOpenEmail(false)}>
                <i className="ri-close-large-line"></i>
              </div>
            </div>
            <h2 className="text-xl text-center mb-[1.5rem] font-semibold mb-3">
            ...
            <p className="mb-[2rem] text-center mt-[1rem]">
              We'll text you a link to verify your email.
            </p>
